                        ...
                        <div class="profile-avatar-wrapper">
                            <label for="avatarInput" class="avatar-label">
                                ...
                                @else
                                    ...
                                    <img id="avatarPreview" class="profile-avatar" style="display: none;" src="">
                                @endif
                ...
                <div class="profile-tabs-card">
                        ...
                        <div class="orders-list">
                            ...
                            <div class="order-card">
                                <div class="order-header">
                                    <button class="order-toggle" type="button" data-bs-toggle="collapse" data-bs-target="#order{{ $order->id }}">
                                        <div class="order-header-left">
                                            <span class="order-number">Zamówienie #{{ $order->id }}</span>
                                            <span class="order-date">{{ $order->created_at->format('d.m.Y H:i') }}</span>
                                        </div>
                                        <div class="order-header-right">
                                            <span class="order-total">{{ number_format($order->total_price, 2, ',', ' ') }} zł</span>
                    ...
                    @else
                        <div class="empty-state">
                            ...
                            <a href="{{ route('home') }}" class="btn-shop">Przejdź do sklepu</a>
                        </div>
                    @endif
                </div>
            </div>
