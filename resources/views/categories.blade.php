            ...
            <div class="categories-grid">
                @auth
                    @if (auth()->user()->is_admin)
                        <div class="category-card category-add-card position-relative">
                            <a href="{{ route('admin.categories.create') }}" class="stretched-link"
                                aria-label="Dodaj kategorię"></a>
                ...
                @foreach ($categories as $category)
                    <div class="category-card position-relative">
                        @auth
                            @if (auth()->user()->is_admin)
                                <div class="admin-controls">
                                    <a href="{{ route('admin.categories.edit', $category) }}" class="btn-admin-edit"
                        ...
                        <a href="{{ route('category', $category->slug) }}" class="stretched-link"
                            aria-label="{{ $category->name }}"></a>
