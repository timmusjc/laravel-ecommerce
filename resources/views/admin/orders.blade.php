...
<div class="container py-5">
    ...
    <div class="d-flex gap-2 justify-content-md-end align-items-center">
        ...
        <a href="{{ route('order_pdf', $order) }}" class="btn btn-sm btn-outline-secondary" title="Pobierz Fakturę" target="_blank">
        ...
        <form action="{{ route('admin.orders.delete', $order) }}" method="POST" onsubmit="return confirm('Czy na pewno chcesz trwale usunąć to zamówienie?');">
            @csrf
            @method('DELETE')
            <button type="submit" class="btn btn-sm btn-outline-danger" title="Usuń zamówienie">
