        ...
        <div class="about-container">
            <div class="about-section">
                ...
                <p class="section-text">
                    TEppLE zostało założone z prostą misją - uczynić najnowszą technologię dostępną dla wszystkich. Od
                    początku naszej drogi koncentrowaliśmy się na dostarczaniu produktów najwyższej jakości w
                    konkurencyjnych cenach.
                </p>
                <p class="section-text">
                    Dziś jesteśmy dumni z tego, że możemy służyć tysiącom zadowolonych klientów, oferując szeroki wybór
                    elektroniki - od smartfonów po sprzęt komputerowy. Nasza pasja do technologii napędza nas każdego dnia
                    do doskonalenia naszej oferty i obsługi.
                </p>
            </div>
