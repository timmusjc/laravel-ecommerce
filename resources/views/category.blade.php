    ...
    <div class="catalog-page py-4 py-md-5">
        <div class="container catalog-container">
            ...
            <div class="category-header">
                ...
                @if (count($products) > 0)
                    <p class="category-count">{{ count($products) }}
                        {{ count($products) == 1 ? 'produkt' : (count($products) < 5 ? 'produkty' : 'produktów') }}</p>
                @endif
            </div>
                    ...
                    @if (auth()->user()->is_admin)
                        <div class="product-card">
                            ...
                            <div class="product-content">
                                <a href="{{ route('admin.products.create', ['category_id' => $category->id]) }}" class="product-name">
                                    Dodaj nowy produkt
                                </a>
